...
class E2ETests(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Chrome(
            executable_path=r"C:\Users\Anonymous\Documents\TDD_Python\chromedriver.exe"
        )
    ...
    def test_browser_title_contain_app_name(self):
    ...
    def test_page_has_button_for_submitting_text(self):
        input_element = self._find("find-button")
        self.assertIsNotNone(input_element)
